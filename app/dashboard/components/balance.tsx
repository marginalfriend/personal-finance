...
import { balance, income, expenses, accountReceivable, debt } from "../actions";
...
export async function Expenses() {
  return (
    <Card>
      ...
      <CardContent>
        <div className="text-2xl font-bold text-red-600">-${expenses}</div>
        {/* <p className="text-xs text-muted-foreground">
          +20.1% from last month
        </p> */}
      </CardContent>
...
export async function AccountReceivable() {
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-sm font-medium">Acc Receivable</CardTitle>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="none"
